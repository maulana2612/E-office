                            ...
                            <div class="portlet-heading">
                                ...
                                <div class="form-group">
                                    <div class="input-group">
                                        <span style="padding-right:75px;" class="input-group-addon">Kepada:</span>
                                ...
                                <div class="form-group">
                                    <div class="input-group">
                                        <span  style="padding-right:73px;" class="input-group-addon">Dari:</span>
                                        <select class="form-control" name="pengirim" id="exampleFromControlSelect1">
                                            <option>Kepala Bidang Telematika</option>
                                            <option>2</option>
                                            <option>3</option>
                                            <option>4</option>
                                        </select>
                                ...
                                <div class="form-group">
                                    <div class="input-group">
                                        <span  style="padding-right:48px;" class="input-group-addon">Tanggal:</span>
                                        <input type="date" name="tgl" class="form-control">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <div class="input-group">
                                        <span style="padding-right:53px;" class="input-group-addon">Nomor:</span>
                                        <input type="text" name="no_surat" class="form-control">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <div class="input-group">
                                        <span  style="padding-right:70px;" class="input-group-addon">Sifat:</span>
                                        <select class="form-control" name="sifat" id="exampleFromControlSelect1">
                                            <option>Biasa</option>
                                            <option>2</option>
                                            <option>3</option>
                                            <option>4</option>
                                ...
                                <div class="form-group">
                                    <div class="input-group">
                                        <span style="padding-right:36px;" class="input-group-addon">Lampiran:</span>
                                            <select class="form-control" id="exampleFromControlSelect1" name="lampiran">
                                ...
                                <div class="form-group">
                                    <div class="input-group">
                                        <span style="padding-right:75px;" class="input-group-addon">Hal:</span>
                    ...
                    <div class="col-lg-12">
                        <div class="portlet portlet-default">
                            <div class="portlet-heading">
                                ...
                                <div class="form-group">
                                    <div class="input-group">
                                        <span style="padding-right:52px;" class="input-group-addon"></span>
                                        <select class="form-control" id="exampleFromControlSelect1" name="paraf">
                                            <option>Kepala Pengembangan</option>
                                            <option>2</option>
                                            <option>3</option>
                                            <option>4</option>
                                        </select>
                        ...
                        <div class="portlet portlet-default">
                            <div class="portlet-heading">
                                ...
                                <div class="form-group">
                                    <div class="input-group">
                                        <span style="padding-right:52px;" class="input-group-addon"></span>
                                        <select class="form-control" id="exampleFromControlSelect1" name="tembusan">
                                            <option>Tembusan disampaikan kepada Yth. </option>
                                            <option>2</option>
                                            <option>3</option>
                                            <option>4</option>
                                        </select>
                             ...
                             <div class="portlet-footer" style="align-items: center; justify-content: space-between;">
                                <div class="btn-toolbar" role="toolbar">
                                    <label class="" for="exampleFormControlSelect2">Paper Size:</label>
                                    <select class="" id="exampleFormControlSelect2">
                                            <option>A4</option>
                                            <option>A3</option>
                                            <option>3</option>
                                    </select>
                                ...
                                <br>                                    
                                <button type="submit" name="tambah" class="btn btn-defaulf"><i class="fa fa-envelope"></i>kirim</button>
                                    
                                <button class="btn btn-red"><i class="fa fa-times"></i> Hapus</button>
                                    <button class="btn btn-green"><i class="fa fa-paperclip"></i> Lampiran</button>
                                    <button class="btn btn-withe"><i class="fa fa-search"></i> Preview</button>
                                </div>
                            </div>
                        </div>
                    </div>
