                ...
                <ul id="side" class="nav navbar-nav side-nav">
                    ...
                    <li class="side-user hidden-xs">
                        ...
                        <p class="name tooltip-sidebar-logout">
                            John
                            <span class="last-name">Ronald</span> <a style="color: inherit" class="logout_open" href="#logout" data-toggle="tooltip" data-placement="top" title="Logout"><i class="fa fa-sign-out"></i></a>
                        </p>
                    ...
                    <li>
                        <a class="active" href="../pegawai/index.html">
                            <i class="fa fa-dashboard"></i> Dashboard
                        </a>
                    </li>
                    <!-- end DASHBOARD LINK -->
                    <li>
                        <a href="../pegawai/mailbox.html">
                    ...
                    <li class="panel">
                        ...
                        <ul class="collapse nav" id="forms">
                            <li>
                                <a href="<?php echo base_url() ?>asset/sekretariat/nota_dinas.html">
