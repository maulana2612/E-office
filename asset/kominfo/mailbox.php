...
<body>
                                                ...
                                                <tbody>
                                                   <tr class="unread-message clickableRow"> 
                                                    <td class="checkbox-col">
                                                        ...
                                                        <td class="from-col">Pengirim</td>
                                                        <td class="from-col">Perihal</td>
                                                        <td class="from-col">Tanggal</td>
                                                        <td class="from-col">Status</td>
                                                        </td>
                                                    </tr>
                                                </tbody>
    ...
    <script src="../js/demo/mailbox-demo.js"></script>
