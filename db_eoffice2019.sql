...
('12.1.7', 'UPTD'),
('13.1', 'KEPALA DINAS'),
('13.1.1', 'KELOMPOK JABATAN FUNGSIONAL'),
('13.1.2', 'SEKERTARIAT'),
('13.1.2.1', 'SUB BAGIAN PERENCANAAN'),
('13.1.2.2', 'SUB BAGIAN UMUM DAN KEUANGAN'),
('13.1.3', 'BIDANG KETERSEDIAAN DAN KERAWANAN PANGAN'),
('13.1.3.1', 'SEKSI KETERSEDIAAN PANGAN'),
('13.1.3.1.1', 'STAFF KETERSEDIAAN PANGAN'),
('13.1.3.2', 'SEKSI SUMBER DAYA PANGAN'),
('13.1.3.2.1', 'STAFF SUMBER DAYA PANGAN'),
('13.1.3.3', 'SEKSI KERAWANAN PANGAN'),
('13.1.3.3.1', 'STAFF KERAWANAN PANGAN'),
('13.1.4', 'BIDANG DISTRIBUSI DAN CADANGAN PANGAN'),
('13.1.4.1', 'SEKSI DISTRIBUSI PANGAN'),
('13.1.4.1.1', 'STAFF DISTRIBUSI PANGAN'),
('13.1.4.2', 'SEKSI HARGA PANGAN'),
('13.1.4.2.1', 'STAFF HARGA PANGAN'),
('13.1.4.3', 'SEKSI CADANGAN PANGAN'),
('13.1.4.3.1', 'STAFF CADANGAN PANGAN'),
('13.1.5', 'BIDANG KONSUMSI DAN KEAMANAN PANGAN'),
('13.1.5.1', 'SEKSI KONSUMSI PANGAN'),
('13.1.5.1.1', 'STAFF KONSUMSI PANGAN'),
('13.1.5.2', 'SEKSI PENGANEKARAGAMAN KONSUMSI PANGAN'),
('13.1.5.2.1', 'STAFF PENGANEKARAGAMAN KONSUMSI PANGAN'),
('13.1.5.3', 'SEKSI KEAMANAN PANGAN'),
('13.1.5.3.1', 'STAFF KEAMANAN PANGAN'),
('13.1.6', 'UPTD'),
('2.1', 'SEKERTARIS DPRD'),
...
INSERT INTO `surat` (`id_surat`, `kepada`, `surat`, `no_surat`, `sifat`, `lampiran`, `hal`, `isi`, `penanda_tangan`, `paraf`, `tembusan`, `perintah_tugas`, `pengantar`, `pengirim`, `nama_jenis_surat`, `tgl_kirim_surat`, `tgl_terima_surat`) VALUES
